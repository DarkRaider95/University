...
import taass.exception.OAuth2AuthenticationProcessingException;
...
import taass.security.oauth2.user.OAuth2UserInfo;
import taass.security.oauth2.user.OAuth2UserInfoFactory;
...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
    ...
    private User registerNewUser(OAuth2UserRequest oAuth2UserRequest, OAuth2UserInfo oAuth2UserInfo) {
        ...
        if (oAuth2UserInfo.getImageUrl().length() < 256)
