<template>
  <ul class="nav nav-mobile-menu" v-if="isLoggedIn">
    <base-dropdown tag="li">
      <template slot="title">
        <i class="nc-icon nc-planet"></i>
        <b class="caret"></b>
        <span class="notification" v-if="this.$store.state.unread === 1" @click="readNotifications">{{this.$store.state.unread}} nuova richiesta</span>
        <span class="notification" v-if="this.$store.state.unread > 1" @click="readNotifications">{{this.$store.state.unread}} nuove richieste</span>
      </template>
      <span class="dropdown-item" v-if="this.notifyRead.length==0">Non ci sono notifiche</span>
    ...
    <li class="nav-item">
      <a class="nav-link"  v-on:click="$router.push('/profile')">
        <i class="nc-icon nc-circle-09"></i>
        {{this.$store.getters.user}}
      </a>
    </li>
    <li class="nav-item" style="text-align: center">
      <a class="nav-link navbar-ct-red" @click="logout">
        <span>Log out</span>
      </a>
    </li>
  </ul>
  <ul class="nav nav-mobile-menu" v-else-if="!isLoggedIn">
    <li class="nav-item" style="text-align: center"  @click="login"><!--$router.push('/login')">-->
      <a class="nav-link navbar-ct-blue" >
        <span>Log In</span>
      </a>
    </li>
  </ul>
