	...
	if(type(Object) == list):
		...
		for item in Object:
			...
			if item[1] == 'd':
				...
				html+="<div class='directory'><a href=\"/"+item[0]+"\\\"><img src='/resources/directory.png' alt='img-directory'><br>"+item[0]+"</a></div>\n"
	else:
		html = "<p>"+Object+"</p>"
