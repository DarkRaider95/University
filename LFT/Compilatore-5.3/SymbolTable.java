...
public class SymbolTable {
     ...
     Map <String, Integer> TypeMap = new HashMap <String, Integer>(); //symbol table type
     Map <String, Integer> OffsetMap = new HashMap <String,Integer>(); //symbol table offset

	public void insert( String s, Integer t, int address ) {
	...
	public Integer lookupType ( String s) {
