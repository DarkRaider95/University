public class Instruction {
	...
	public String toJasmin (String f) {
		String temp="";
        switch (opCode) {
            case ldc : temp = " ldc "+ operand + "\n"; break;
            case iadd : temp = " iadd " + "\n"; break;
            case invokestatic : if( operand == 1)  temp = " invokestatic "+ f +"/printInt(I)V" + "\n";
                                else temp =" invokestatic " + f +"/printBool(I)V" + "\n";break;
            case imul : temp = " imul " + "\n"; break;
            case idiv : temp = " idiv " + "\n"; break;
            case ineg : temp = " ineg " + "\n"; break;
            case ixor : temp = " ixor " + "\n"; break;
